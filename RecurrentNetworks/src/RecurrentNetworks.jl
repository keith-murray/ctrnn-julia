...
export main
function main(training::String, testing::String, seed::Int64, batch::Int64, epochs::Int64, gain_init::Float32, gain_recur::Float32, gain_out::Float32, tau::Float32, noise_IC::Float32, noise_recur::Float32, L2_mag::Float32, AR_mag::Float32, lr::Float32)
    ...
    model, ps, st = create_model(rng, gain_init, gain_recur, gain_out, tau, noise_IC, noise_recur)
...
function schedule(location::String, output::String, row_num::Int64)
    ...
    ps_out, accuracies = main(row[1], row[2], row[3], row[4], row[5], row[6], row[7], row[8], row[9], row[10], row[11], row[12], row[13], row[14])

...
# ╔═╡ d48ba151-8976-47ea-91a0-82918a9f15db
begin
	using Lux
	using ComponentArrays, CUDA, SciMLSensitivity, NNlib, Optimisers, OrdinaryDiffEq, Random, Statistics, Zygote, OneHotArrays
	import MLDatasets: MNIST
	import MLUtils: DataLoader, splitobs
end

# ╔═╡ cc53b7c2-c2d3-11ed-066a-2bf853836cb7
md"# Make SET loader"

# ╔═╡ 7e0c607d-293d-48e2-854e-5d1e5c63cb6f
md"""
The purpose of this notebook is to create a dataloader in Julia for the SET data. I expect that it might be challenging given that the data being fed into the model are functions and have a function type.

Some ways to resolve this issue are:
* load the SET data in a dataloader and then create the function on the fly.
* not use a dataloader and retrieve and generate everything on the fly.
One thing I do not understand is how batchsizes work in Julia.

NOTE: Not all code in this script is of my own creation. Some code blocks are taken from the [Lux.jl tutorial](http://lux.csail.mit.edu/stable/examples/generated/intermediate/NeuralODE/main/).
"""

# ╔═╡ b0e33c0d-b161-4c07-a483-cd493bfdd4fb
md"## Setup"

# ╔═╡ a102cbc3-1b9b-437a-80c7-230a6b35618d
md"## Test existing DataLoader implementation"

# ╔═╡ f305e76c-f117-4e50-a8d6-dbd1593701eb
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "4baa4e7b708f7b4f263e7e86b3ad241e8103ef38"
...
git-tree-sha1 = "170cd867517ac79ecb65b088a80e7127fd1be5a0"
...
git-tree-sha1 = "24d68012fb4ed86e10c97b53c9ed7250a4c17d1d"
...
git-tree-sha1 = "88668b09e66eafc34d6d40a21ecfcb2101c845f9"

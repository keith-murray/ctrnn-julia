...
begin
	run1 = ["./data/data_100_540.jls", 
			"./data/data_100_27.jls",
			0,
			108,
			2500,
			100,
...
column_names = ["training", "testing", "seed", "batch", "epochs", "neurons", "gain_init","gain_recur", "gain_out", "tau", "noise_IC", "noise_recur", "L2_mag", "AR_mag","lr"]
